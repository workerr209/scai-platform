package com.springcore.ai.scaiplatform.core.config;

import com.springcore.ai.scaiplatform.core.properties.CorsProperties;
import com.springcore.ai.scaiplatform.core.security.jwt.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthFilter) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/**", "/api/v0/**", "/api/v1/files/public/**", "/error").permitAll()
    ...
    // Async thread pool and SecurityContext propagation executor have been
    // moved to AsyncConfig — see config/AsyncConfig.java
}
