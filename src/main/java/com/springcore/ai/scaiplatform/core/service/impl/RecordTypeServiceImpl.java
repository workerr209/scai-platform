...
import com.springcore.ai.scaiplatform.core.entity.RecordTypeField;
import com.springcore.ai.scaiplatform.core.properties.ApplicationProperties;
import com.springcore.ai.scaiplatform.core.repository.api.RecordTypeRepository;
...
public class RecordTypeServiceImpl implements RecordTypeService {
	...
	public Flowable<Class<?>> loadClassFromRecordTypeName(String recordTypeName) {
		return Flowable.fromCallable(() -> getRecordTypeOptional(recordTypeName))
